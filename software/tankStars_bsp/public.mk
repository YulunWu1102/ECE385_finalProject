...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1e8
SOPC_SYSID_FLAG += --sidp=0x1e8
ELF_PATCH_FLAG  += --sidp 0x1e8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1650429749
SOPC_SYSID_FLAG += --timestamp=1650429749
ELF_PATCH_FLAG  += --timestamp 1650429749
