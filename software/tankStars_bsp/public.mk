...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../lab62_soc.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1e0
SOPC_SYSID_FLAG += --sidp=0x1e0
ELF_PATCH_FLAG  += --sidp 0x1e0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1650923929
SOPC_SYSID_FLAG += --timestamp=1650923929
ELF_PATCH_FLAG  += --timestamp 1650923929
